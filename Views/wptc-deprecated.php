...
<div class="wrap" id="wptc">
    ...
    <p>
        <?php _e(sprintf('
            <p>Gday,</p>
            <p>WordPress Time Capsule is striving to be the #1 backup solution for WordPress and, in order to do so, it needs to use the latest technologies available.</p>
            ...
            <p>If this is not possible, WPTC 1.3 supports PHP < 5.2.16 and can be <a href="%s">downloaded here</a> and installed using the WordPress plugin uploader.
